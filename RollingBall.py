...
WINDOW_SIZE = 2000
ANGLE= float(input("Enter Angle of Inclination: "))
LINE_START_X= 0.0
LINE_START_Y= WINDOW_SIZE*math.tan(math.radians(ANGLE))
GLOBAL_X_POSTION = 0
GLOBAL_Y_POSTION = WINDOW_SIZE*math.tan(math.radians(ANGLE))
TARGET_FPS=60
RADIUS = float(input("Enter Radius of Ball: "))
FRAMES = 0
j=0.0
SPEED_MULTIPLIER = float(input("Enter Speed Mulitplier: "))
